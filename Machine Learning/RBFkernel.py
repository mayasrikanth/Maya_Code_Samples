...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 27 00:32:06 2018

@author: mayasrikanth
"""
import numpy as np
from sklearn.svm import SVC
# Implements 1 to 5 Classifier 
# def soft_margin_SVM(classifier):
def soft_margin_SVM(choose_C):
    ...
    # Creating SVC, RBF kernel w/ Q = 2, C = 0.01
    clf = SVC(gamma=1, coef0=1, C=choose_C, kernel='rbf')
